...
vim.api.nvim_create_user_command("StartAgent", function()
  ...
  require('hjdivad.agent').StartAgent('cursor')
end, { desc = "Start a CLI Agent" })
vim.api.nvim_create_user_command("StartAgentPrompt", function()
  require('hjdivad.agent').StartAgentPrompt()
end, { desc = "Start an agent prompt session" })
