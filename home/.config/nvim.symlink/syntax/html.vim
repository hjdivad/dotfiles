" Fork of /usr/local/Cellar/neovim/0.4.4/share/nvim/runtime/syntax/html.vim
" with hX groups disabled so they're treated as regular html tags.
" without this glimmer components in HX tags cause rendering issues for the
" rest of the file.
"
"
"
